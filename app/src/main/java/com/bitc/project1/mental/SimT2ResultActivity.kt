...
import com.bitc.project1.databinding.ActivitySimT2ResultBinding

class SimT2ResultActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivitySimT2ResultBinding.inflate(layoutInflater)
