...
import com.bitc.project1.databinding.FragmentGhostBinding


class GhostFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_ghost, container, false)
        ...
        val questions = resources.getStringArray(R.array.dreamGhost_questions)
        val answers = resources.getStringArray(R.array.dreamGhost_answers)
