...
import com.bitc.project1.databinding.ActivityMbtiIsBinding
...
class MbtiISActivity : AppCompatActivity() {
    private var binding: ActivityMbtiIsBinding? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        // 기존의 binding 프로퍼티를 초기화합니다.
        binding = ActivityMbtiIsBinding.inflate(layoutInflater)
        ...
        binding!!.submitButton.setOnClickListener {
            ...
            if (score > 12 && pjscore > 12) {
                startActivity(Intent(this, MbtiISFJActivity::class.java))
            } else if(score > 12 && pjscore <= 12){
                startActivity(Intent(this, MbtiISFPActivity::class.java))
            } else if(score <= 12 && pjscore > 12){
                startActivity(Intent(this, MbtiISTJActivity::class.java))
            } else {
                startActivity(Intent(this, MbtiISTPActivity::class.java))
            }
            } else {
