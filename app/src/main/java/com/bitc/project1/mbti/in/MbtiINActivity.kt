...
import com.bitc.project1.databinding.ActivityMbtiInBinding
import com.bitc.project1.mbti.QuizActivity
import com.bitc.project1.mbti.es.MbtiESFJActivity
import com.bitc.project1.mbti.es.MbtiESFPActivity
import com.bitc.project1.mbti.es.MbtiESTJActivity
import com.bitc.project1.mbti.es.MbtiESTPActivity

class MbtiINActivity : AppCompatActivity() {
    private var binding: ActivityMbtiInBinding? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        // 기존의 binding 프로퍼티를 초기화합니다.
        binding = ActivityMbtiInBinding.inflate(layoutInflater)
        ...
        binding!!.submitButton.setOnClickListener {
            ...
            if (score > 12 && pjscore > 12) {
                startActivity(Intent(this, MbtiINFJActivity::class.java))
            } else if(score > 12 && pjscore <= 12){
                startActivity(Intent(this, MbtiINFPActivity::class.java))
            } else if(score <= 12 && pjscore > 12){
                startActivity(Intent(this, MbtiINTJActivity::class.java))
            } else {
                startActivity(Intent(this, MbtiINTPActivity::class.java))
            }
            } else {
