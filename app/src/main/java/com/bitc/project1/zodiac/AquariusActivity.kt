...
import com.bitc.project1.databinding.ActivityAquariusBinding

class AquariusActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivityAquariusBinding.inflate(layoutInflater)
