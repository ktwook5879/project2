...
import com.bitc.project1.databinding.ActivityTaurusBinding

class TaurusActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivityTaurusBinding.inflate(layoutInflater)
