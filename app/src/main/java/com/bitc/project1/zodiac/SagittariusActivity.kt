...
import com.bitc.project1.databinding.ActivitySagittariusBinding

class SagittariusActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivitySagittariusBinding.inflate(layoutInflater)
