...
import com.bitc.project1.databinding.ActivityPiscesBinding

class PiscesActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivityPiscesBinding.inflate(layoutInflater)
